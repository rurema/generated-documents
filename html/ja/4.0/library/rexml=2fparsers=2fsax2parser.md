...
コールバックをパーサオブジェクトに [REXML::Parsers::SAX2Parser#listen](../method/REXML=3a=3aParsers=3a=3aSAX2Parser/i/listen.md) で設定してから [REXML::Parsers::SAX2Parser#parse](../method/REXML=3a=3aParsers=3a=3aSAX2Parser/i/parse.md) を呼び出すことで、パーサからコールバックが呼び出されます。

コールバックには2種類あって、ブロックを使う方式と [REXML::SAX2Listener](../class/REXML=3a=3aSAX2Listener.md)
を include したクラスのオブジェクトを使う方式があります。詳しくは
[REXML::Parsers::SAX2Parser#listen](../method/REXML=3a=3aParsers=3a=3aSAX2Parser/i/listen.md) を参照してください。

[REXML::Parsers::StreamParser](../class/REXML=3a=3aParsers=3a=3aStreamParser.md) のパーサよりは高機能です。
