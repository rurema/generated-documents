...
主な使い方は [fiddle](../library/fiddle.md) も参照してください。
...
があったとします。これを呼び出したい場合は以下のように [Array#pack](../method/Array/i/pack.md) を使用します。
...
があったとします。これを呼び出すにも以下のように [Array#pack](../method/Array/i/pack.md) を使用します。
...
任意のクラスの Ruby オブジェクトをコールバックへ渡したい場合は [Fiddle?.dlwrap](../method/Fiddle/m/dlwrap.md) を使ってポインタ(整数)へ変換してから関数に渡し、コールバックの方で元に戻します。
...
構造体をメンバとして持つ構造体を [Fiddle::Importer#struct](../method/Fiddle=3a=3aImporter/i/struct.md) を使って定義することは残念ながらできません。
自力でメンバを展開してから [Fiddle::Importer#struct](../method/Fiddle=3a=3aImporter/i/struct.md) を使ってください。
