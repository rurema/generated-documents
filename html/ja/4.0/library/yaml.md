...
[yaml](../library/yaml.md) ライブラリでは、以下のライブラリをバックエンドとして使用します。

- [psych](../library/psych.md) ライブラリ: YAML バージョン 1.1 を扱う事ができます。
...
[yaml](../library/yaml.md) では、Ruby 向けに以下のローカルタグを扱えます。

- !ruby/array: [Array](../class/Array.md) オブジェクト
- !ruby/class: [Class](../class/Class.md) オブジェクト
- !ruby/hash:  [Hash](../class/Hash.md) オブジェクト
- !ruby/module:  [Module](../class/Module.md) オブジェクト
- !ruby/regexp:  [Regexp](../class/Regexp.md) オブジェクト
- !ruby/range: [Range](../class/Range.md) オブジェクト
- !ruby/string: [String](../class/String.md) オブジェクト
- !ruby/struct: [Struct](../class/Struct.md) オブジェクト
- !ruby/sym(もしくは !ruby/symbol): [Symbol](../class/Symbol.md) オブジェクト
- !ruby/encoding: [Encoding](../class/Encoding.md) オブジェクト
...
無名クラスを YAML 形式に変換すると [TypeError](../class/TypeError.md) が発生します。また、
[IO](../class/IO.md) や [Thread](../class/Thread.md) オブジェクトなどはインスタンス変数がオブジェクトの状態を保持していないため、変換はできますが、YAML.load した時に完全に復元できない事に注意してください。

標準添付の yaml 関連ライブラリには以下のようなRuby 独自の拡張、制限があります。標準添付ライブラリ以外で yaml を扱うライブラリを使用する場合などに注意してください。

- ":foo" のような文字列はそのまま [Symbol](../class/Symbol.md) として扱える
- "y" や "n" は真偽値として扱われない
