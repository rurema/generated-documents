...
[Net::HTTP.new](../method/Net=3a=3aHTTP/s/new.md) や [Net::HTTP.start](../method/Net=3a=3aHTTP/s/start.md) の proxy_addr 引数に
nil を渡してください。

[Net::HTTP.new](../method/Net=3a=3aHTTP/s/new.md) や [Net::HTTP.start](../method/Net=3a=3aHTTP/s/start.md) の proxy_addr や proxy_port
...
詳しくは [Net::HTTP.new](../method/Net=3a=3aHTTP/s/new.md) を参照してください。
...
より詳しくは [Net::HTTPResponse](../class/Net=3a=3aHTTPResponse.md)、 [Net::HTTPSuccess](../class/Net=3a=3aHTTPSuccess.md)、
[Net::HTTPRedirection](../class/Net=3a=3aHTTPRedirection.md) を参照してください。
...
なお Ruby 標準の [cgi](../library/cgi.md) ライブラリでは '&' と ';' の両方サポートしていますので、
[cgi](../library/cgi.md) ライブラリを使って CGI スクリプトを書く場合はこれらの違いを気にする必要はありません。
