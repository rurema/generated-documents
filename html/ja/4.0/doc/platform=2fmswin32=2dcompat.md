...
[platform/Win32-native](../doc/platform=2fWin32=2dnative.md)Rubyは、できる限りUnix版と同等の動作をするように意図して作られていますが、
...
ドライブレター絡みで未だに幾つかの実装上の漏れがあります--[platform/DOSISH-support](../doc/platform=2fDOSISH=2dsupport.md)。
また、同様に、-Ksを指定してあっても、日本語ファイル名の扱いで問題が発生することがあります。
