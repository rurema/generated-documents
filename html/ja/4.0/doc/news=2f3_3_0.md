...
## 組み込みクラスの更新(注目すべきもののみ)
  ...
  - [Array](../class/Array.md)
    - 変更されたメソッド
      - [Array#pack](../method/Array/i/pack.md)が不明なディレクティブに対してArgumentErrorを発生するようになりました。 [bug:19150]
  ...
  - [Process::Status](../class/Process=3a=3aStatus.md)
    - 変更されたメソッド
      - `Process::Status#&` と `Process::Status#>>` が非推奨になりました。[bug:19868]
  ...
  - [String](../class/String.md)
    - 変更されたメソッド
      - [String#unpack](../method/String/i/unpack.md)が不明なディレクティブに対して ArgumentError を投げるようになりました。[bug:19150]
      - [String#bytesplice](../method/String/i/bytesplice.md)がコピー元の文字列のインデックス/長さまたはrangeを引数に取れるようになりました。これによりコピー元の部分範囲を指定できるようになりました。[feature:19314]

  - [Thread::Queue](../class/Thread=3a=3aQueue.md)
    - 変更されたメソッド
      - `Thread::Queue#freeze`がTypeErrorを発生するようになりました。 [bug:17146]

  - [Thread::SizedQueue](../class/Thread=3a=3aSizedQueue.md)
    - 変更されたメソッド
      - `Thread::SizedQueue#freeze`がTypeErrorを発生するようになりました。 [bug:17146]

  - [Time](../class/Time.md)
    - 変更されたメソッド
      - [Time.new](../method/Time/s/new.md)の文字列引数がより厳格になりました。 [bug:19293]
...
## 標準添付ライブラリの更新(機能追加とバグ修正を除く)
  ...
  - [Socket.getaddrinfo](../method/Socket/s/getaddrinfo.md) [Socket.getnameinfo](../method/Socket/s/getnameinfo.md) [Addrinfo.getaddrinfo](../method/Addrinfo/s/getaddrinfo.md) などの名前解決を中断できるようになりました。 [feature:19965]

  - [Random::Formatter#alphanumeric](../method/Random=3a=3aFormatter/i/alphanumeric.md) がオプションの chars キーワード引数を受け取るようになりました。[feature:18183]
...
## 互換性に関する変更
  ...
  - 以下のファイルオープンメソッドによるサブプロセスの作成/フォークは非推奨です。[feature:19630]
    - [Kernel?.open](../method/Kernel/m/open.md)
    - [URI.open](../method/URI/s/open.md)
    - [IO.binread](../method/IO/s/binread.md)
    - [IO.foreach](../method/IO/s/foreach.md)
    - [IO.readlines](../method/IO/s/readlines.md)
    - [IO.read](../method/IO/s/read.md)
    - [IO.write](../method/IO/s/write.md)
  - [Kernel?.lambda](../method/Kernel/m/lambda.md)が非ラムダ式、非リテラルブロックが与えられた場合、Ruby 3.0 以降では deprecated category の警告を発していましたが、ArgumentError を発生させるようになりました。[feature:19777]
...
## C APIの変更
  ...
  - 内部スレッドイベントフックAPIの更新
    - rb_internal_thread_event_data_t が対象 Ruby スレッド（VALUE）を保持し、そのデータがコールバック関数（rb_internal_thread_event_callback）に渡されるようになりました。<https://github.com/ruby/ruby/pull/8885>
    - 内部スレッドイベントフック API から Ruby スレッドローカルデータを操作するために以下の関数が追加されました (Ruby 3.2 以降で導入されていました) 。<https://github.com/ruby/ruby/pull/8936>
...
### パーサー
  ...
  - Bison から Lrama LALRパーサジェネレータ(<https://github.com/ruby/lrama>) に置き換えられました。これにより、ソースコードから Ruby をビルドするために Bison をインストールする必要がなくなりました。また bison の互換性問題に悩まされることがなくなり、新機能を Lrama に実装するだけで利用できるようになります。[feature:19637]
    - 興味がある方は、The future vision of Ruby Parser(<https://rubykaigi.org/2023/presentations/spikeolaf.html>)の発表をご覧ください。
...
### GC / メモリ管理
  ...
  - Ruby 3.2 からの大幅なパフォーマンス向上
    ...
    - ライトバリアが [Time](../class/Time.md), [Enumerator](../class/Enumerator.md), [MatchData](../class/MatchData.md), [Method](../class/Method.md), [File::Stat](../class/File=3a=3aStat.md), [BigDecimal](../class/BigDecimal.md) など多くのクラスに実装されました。これにより minor GC の収集時間と major GC の収集頻度が削減されました。
    - [Hash](../class/Hash.md), [Time](../class/Time.md), Thread::Backtrace, [Thread::Backtrace::Location](../class/Thread=3a=3aBacktrace=3a=3aLocation.md), [File::Stat](../class/File=3a=3aStat.md), [Method](../class/Method.md) などほとんどの組み込みクラスで Variable Width Allocation(VWA) が使用されるようになりました。これにより、これらのクラスの確保と解放が高速になり、メモリ使用量が減少し、ヒープの断片化が低減されます。
...
### RJIT
  ...
  - RubyのJITの開発に興味がある場合は、RubyKaigi 2023のk0kubunの発表(<https://rubykaigi.org/2023/presentations/k0kubun.html#day3>)をご覧ください。
