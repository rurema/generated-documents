...
- **`__method__ \[new]`**:
  ...
  <https://web.archive.org/web/20060819042136/http://www.dm4lab.to/~usa/ruby/d/200606a.html#id20060610_P1_7>
...
[[ruby-cvs:16833]](https://web.archive.org/web/20090109060329/http://www.atdot.net/~ko1/w3ml/w3ml.cgi/ruby-cvs/msg/16833)

[Dissecting matz's monster patch: lots of activity in 1.9 (2006-06)](https://web.archive.org/web/20071218110147/http://eigenclass.org/hiki.rb?Changes+in+Ruby+1.9+update+4)
...
- **[BasicSocket.do_not_reverse_lookup](../method/BasicSocket/s/do_not_reverse_lookup.md)  \[compat]**:
...
- **Ruby 2.0 ブロックローカル変数**:
  ...
  <https://matz.rubyist.net/20050309.html#p03>
...
- **`RSS Parser/Maker \[lib] \[new]`**:
  ...
  [Imageモジュール](https://web.resource.org/rss/1.0/modules/image/)のサポート
...
- **[ripper/Ripper.slice] \[ruby] \[experimental]**:
  ...
  追加。<https://i.loveruby.net/d/20050201.html#p02>
...
- **`Array#[]= \[change]`**:
  ...
  [zw-kdoo(2004-10-24)](https://web.archive.org/web/20050225230615/https://yowaken.dip.jp/tdiary/20041024.html#c02)
...
- **`Hash#index \[obsolete]`**:
  ...
  [ruby-talk:113279]
  <https://matz.rubyist.net/20040922.html#p01>
...
- **`[m:IO.popen]             \[compat]`**:
  ...
  [Kernel?.system](../method/Kernel/m/system.md) 等と同様、第一引数に配列でコマンドを指定し
...
- **[Kernel?.system](../method/Kernel/m/system.md)     \[change]**:
