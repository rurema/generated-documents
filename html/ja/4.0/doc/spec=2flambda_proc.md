...
- [def](#def)
- [proc_generation](#proc_generation)
- [should_use_next](#should_use_next)
- [block](#block)
...
手続きオブジェクトとはブロックをコンテキスト(ローカル変数のスコープやスタックフレーム)とともにオブジェクトにしたものです。[Proc](../class/Proc.md) クラスのインスタンスとして実現されています。
