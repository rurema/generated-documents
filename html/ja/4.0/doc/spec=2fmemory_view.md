...
`format` は以下の [pack_template](../doc/pack_template.md) を並べた文字列です。
...
- **`bool native_size_p`**: ネイティブ（システム依存）のサイズかどうか。 [pack_template](../doc/pack_template.md) の「整数のテンプレート文字のシステム依存性」の項参照。
...
クラスとメモリビューエントリ構造体 `rb_memory_view_entry_t` を [rb_memory_view_register](../function/rb_memory_view_register.md) に渡して、そのクラスのオブジェクトがメモリビューをエクスポートできるようにします。エントリ構造体にはメモリビューをエクスポート、解放、対応可否の判定をする際に必要な関数ポインタをメンバとして持たせます。
...
- [rb_memory_view_register](../function/rb_memory_view_register.md)
- [rb_memory_view_init_as_byte_array](../function/rb_memory_view_init_as_byte_array.md)
- [rb_memory_view_fill_contiguous_strides](../function/rb_memory_view_fill_contiguous_strides.md)
- [rb_memory_view_prepare_item_desc](../function/rb_memory_view_prepare_item_desc.md)

#### コンシューマ API

- [rb_memory_view_available_p](../function/rb_memory_view_available_p.md)
- [rb_memory_view_get](../function/rb_memory_view_get.md)
- [rb_memory_view_release](../function/rb_memory_view_release.md)
- [rb_memory_view_parse_item_format](../function/rb_memory_view_parse_item_format.md)
- [rb_memory_view_item_size_from_format](../function/rb_memory_view_item_size_from_format.md)
- [rb_memory_view_get_item_pointer](../function/rb_memory_view_get_item_pointer.md)
- [rb_memory_view_get_item](../function/rb_memory_view_get_item.md)
- [rb_memory_view_is_contiguous](../function/rb_memory_view_is_contiguous.md)
- [rb_memory_view_extract_item_members](../function/rb_memory_view_extract_item_members.md)
- [rb_memory_view_is_row_major_contiguous](../function/rb_memory_view_is_row_major_contiguous.md)
- [rb_memory_view_is_column_major_contiguous](../function/rb_memory_view_is_column_major_contiguous.md)
