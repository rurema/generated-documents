...
- [`IO#read(size)`](../method/IO/i/read.md)
...
- [beep](../method/IO/i/beep.md)
- [binmode](../method/IO/i/binmode.md)
- [binmode?](../method/IO/i/binmode=3f.md)
- [check_winsize_changed](../method/IO/i/check_winsize_changed.md)
- [clear_screen](../method/IO/i/clear_screen.md)
...
- [console_mode](../method/IO/i/console_mode.md)
- [console_mode=](../method/IO/i/console_mode=3d.md)
- [cooked](../method/IO/i/cooked.md)
- [cooked!](../method/IO/i/cooked=21.md)
- [cursor](../method/IO/i/cursor.md)
- [cursor=](../method/IO/i/cursor=3d.md)
- [cursor_down](../method/IO/i/cursor_down.md)
- [cursor_left](../method/IO/i/cursor_left.md)
- [cursor_right](../method/IO/i/cursor_right.md)
- [cursor_up](../method/IO/i/cursor_up.md)
...
- [erase_line](../method/IO/i/erase_line.md)
- [erase_screen](../method/IO/i/erase_screen.md)
...
- [getpass](../method/IO/i/getpass.md)
- [gets](../method/IO/i/gets.md)
- [goto](../method/IO/i/goto.md)
- [goto_column](../method/IO/i/goto_column.md)
...
- [pressed?](../method/IO/i/pressed=3f.md)
...
- [scroll_backward](../method/IO/i/scroll_backward.md)
- [scroll_forward](../method/IO/i/scroll_forward.md)
...
- [ttyname](../method/IO/i/ttyname.md)
