...
[Numeric#modulo](../method/Numeric/i/modulo.md) メソッドと [Numeric#remainder](../method/Numeric/i/remainder.md) メソッドとして実装されています。
...
Ruby 3.2 では整商を得るメソッドとして [Integer#ceildiv](../method/Integer/i/ceildiv.md) が導入されました。
