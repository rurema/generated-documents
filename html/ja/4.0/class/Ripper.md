...
[Ripper::Filter](../class/Ripper=3a=3aFilter.md) クラスを使うとよいでしょう。
...
- [sexp_raw](../method/Ripper/s/sexp_raw.md)
- [slice](../method/Ripper/s/slice.md)
- [token_match](../method/Ripper/s/token_match.md)
- [tokenize](../method/Ripper/s/tokenize.md)
...
- [compile_error](../method/Ripper/i/compile_error.md)
- [warn](../method/Ripper/i/warn.md)
- [warning](../method/Ripper/i/warning.md)
