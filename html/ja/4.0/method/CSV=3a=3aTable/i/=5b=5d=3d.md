...
このメソッドを呼び出す前に [CSV::Table#by_col!](../../../method/CSV=3a=3aTable/i/by_col=21.md) を呼び出すとカラムモードになります。また [CSV::Table#by_row!](../../../method/CSV=3a=3aTable/i/by_row=21.md) を呼び出すとロウモードになります。

行には配列か [CSV::Row](../../../class/CSV=3a=3aRow.md) のインスタンスを指定します。
