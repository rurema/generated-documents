...
- **param** `format` -- フォーマット文字列を指定します。使用できるものは 以下の通りです。
  ...
  - %P: 午前または午後(am,pm)
  - %p: 午前または午後(AM,PM)
  - %Q: 1970-01-01 00:00:00 UTC からの経過ミリ秒 ([Time#strftime](../../../method/Time/i/strftime.md) は対応していませんが、[Date#strftime](../../../method/Date/i/strftime.md) で使えます)
  - %R: 24時間制の時刻。%H:%M と同等。
  ...
  - %%: %自身
  - %+: [man:date(1)]の形式 (%a %b %e %H:%M:%S %Z %Y) ([Time#strftime](../../../method/Time/i/strftime.md) は対応していませんが、[Date#strftime](../../../method/Date/i/strftime.md) で使えます)
