...
`self` が [Integer](../../../class/Integer.md) や [Rational](../../../class/Rational.md) で、`other` が虚部を持つ [Complex](../../../class/Complex.md) の場合は、商を [Float](../../../class/Float.md) に変換できないため [RangeError](../../../class/RangeError.md) が発生します。
