...
<< メソッドには
- [PrettyPrint#text](../../../method/PrettyPrint/i/text.md) の第1引数 obj
- [PrettyPrint#breakable](../../../method/PrettyPrint/i/breakable.md) の第1引数 sep
- [PrettyPrint.new](../../../method/PrettyPrint/s/new.md) の第3引数 newline
- [PrettyPrint.new](../../../method/PrettyPrint/s/new.md) に与えたブロックを評価した結果
のどれかひとつが引数として与えられます。
