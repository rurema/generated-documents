...
[RubyVM::InstructionSequence.load_from_binary](../../../method/RubyVM=3a=3aInstructionSequence/s/load_from_binary.md) メソッドでバイナリデータに対応するiseqオブジェクトを作れます。

引数の extra_data はバイナリデータと共に保存されます。
[RubyVM::InstructionSequence.load_from_binary_extra_data](../../../method/RubyVM=3a=3aInstructionSequence/s/load_from_binary_extra_data.md) メソッドでこの文字列にアクセス出来ます。
...
- **SEE** [RubyVM::InstructionSequence.load_from_binary](../../../method/RubyVM=3a=3aInstructionSequence/s/load_from_binary.md)
- **SEE** [RubyVM::InstructionSequence.load_from_binary_extra_data](../../../method/RubyVM=3a=3aInstructionSequence/s/load_from_binary_extra_data.md)
