...
[RubyVM](../../../class/RubyVM.md)にアプリケーションの起動が終了したこと及び、アプリケーションの最適化に適したタイミングであることを通知します。
...
3. 全ての文字列のcoderange([String#valid_encoding?](../../../method/String/i/valid_encoding=3f.md)などで使われる文字列の内容とエンコーディングとの整合性の情報)を事前計算します
