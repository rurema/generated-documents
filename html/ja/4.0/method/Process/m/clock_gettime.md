...
### module_function def clock_gettime(clock_id, unit=:float_second) -> Float | Integer
...
たとえば、[Process::CLOCK_REALTIME](../../../method/Process/c/CLOCK_REALTIME.md) は clock_gettime() がない場合は :GETTIMEOFDAY_BASED_CLOCK_REALTIME と定義されています。
...
CLOCK_REALTIME よりも [Time.now](../../../method/Time/s/now.md) をおすすめします。

- **raise** `Errno::EINVAL` -- clock_id がサポートされていない場合に発生します。

- **SEE** [Time.now](../../../method/Time/s/now.md)
