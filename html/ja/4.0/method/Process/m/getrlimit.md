...
返り値は、現在の制限値 cur_limit と、制限値として設定可能な最大値 max_limit の配列 [cur_limit, max_limit] です。

それぞれの limit が [Process::RLIM_INFINITY](../../../method/Process/c/RLIM_INFINITY.md) と等しい場合、リソースに制限がないことを意味します。
