...
[ObjectSpace::InternalObjectWrapper](../../../class/ObjectSpace=3a=3aInternalObjectWrapper.md) オブジェクトが戻り値に含まれます。このオブジェクトは obj が内部で持っているオブジェクトを持ちます。内部のオブジェクトの型を確認する場合は [ObjectSpace::InternalObjectWrapper#type](../../../method/ObjectSpace=3a=3aInternalObjectWrapper/i/type.md)
