...
設定した名前は [Module#name](../../../method/Module/i/name.md) や [Module#inspect](../../../method/Module/i/inspect.md) の結果に反映され、そのモジュール / クラスのインスタンスや定数、メソッドの表示にも使われます。
...
- **SEE** [Module#name](../../../method/Module/i/name.md)
