...
[OptionParser#on](../../../method/OptionParser/i/on.md) で klass を指定した場合、コマンドラインのオプションに与えられた引数は、この accept で登録したブロックで
...
いくつかのクラスに対しては変換用のブロックがデフォルトで登録されています。[OptionParser#on](../../../method/OptionParser/i/on.md) を参照して下さい。
