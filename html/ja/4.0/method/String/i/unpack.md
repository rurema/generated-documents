...
[Array#pack](../../../method/Array/i/pack.md) で生成された文字列をテンプレート文字列 template にしたがってアンパックし、それらの要素を含む配列を返します。
...
- **SEE** [String#unpack1](../../../method/String/i/unpack1.md), [Array#pack](../../../method/Array/i/pack.md)
