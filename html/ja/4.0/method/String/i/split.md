...
sep 省略時の挙動を [[m:$;]] に頼るコードは書くべきではありません。

sep が正規表現で、かつその正規表現に括弧が含まれている場合には、各括弧のパターンにマッチした文字列も配列に含まれます。
...
- **SEE** [String#partition](../../../method/String/i/partition.md), [String#rpartition](../../../method/String/i/rpartition.md)
