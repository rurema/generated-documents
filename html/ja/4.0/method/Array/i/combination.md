...
得られる組み合わせの順序は保証されません。ブロックなしで呼び出されると、組み合わせを生成する [Enumerator](../../../class/Enumerator.md) オブジェクトを返します。
...
- **SEE** [Array#permutation](../../../method/Array/i/permutation.md), [Array#repeated_combination](../../../method/Array/i/repeated_combination.md)
