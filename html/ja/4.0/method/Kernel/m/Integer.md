...
- **param** `base` -- 基数として0か2から36の整数を指定します(引数argに文字列を指定した場合のみ)。省略するか0を指定した場合はプリフィクスから基数を判断します。その場合に認識できるプリフィクスは、0b
...
- **raise** `TypeError` -- メソッド to_int, to_i を持たないオブジェクトを引数に指定したか、to_int, to_i
  が整数([Integer](../../../class/Integer.md)のサブクラス)を返さなかった場合に発生します。
...
- **SEE** [String#hex](../../../method/String/i/hex.md),[String#oct](../../../method/String/i/oct.md),[String#to_i](../../../method/String/i/to_i.md),[Integer](../../../class/Integer.md)
