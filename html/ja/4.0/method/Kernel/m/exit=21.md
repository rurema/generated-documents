...
exit! は exit とは違って、例外処理などは一切行ないません。 [Kernel?.fork](../../../method/Kernel/m/fork.md) の後、子プロセスを終了させる時などに用いられます。
...
- **SEE** [Kernel?.exit](../../../method/Kernel/m/exit.md),[Kernel?.abort](../../../method/Kernel/m/abort.md),[Kernel?.at_exit](../../../method/Kernel/m/at_exit.md),[Kernel?.fork](../../../method/Kernel/m/fork.md)
