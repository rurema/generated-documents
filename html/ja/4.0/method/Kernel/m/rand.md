...
まだ [Kernel?.srand](../../../method/Kernel/m/srand.md) が呼ばれていなければ自動的に呼び出します。

擬似乱数生成器として [Random](../../../class/Random.md) クラスオブジェクトを使用します。
...
- **SEE** [Kernel?.srand](../../../method/Kernel/m/srand.md), [Random#rand](../../../method/Random/i/rand.md), [Random](../../../class/Random.md)
