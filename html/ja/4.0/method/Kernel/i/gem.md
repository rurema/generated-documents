...
[Gem::LoadError](../../../class/Gem=3a=3aLoadError.md) が発生します。

バージョンの指定方法に関しては [Gem::Version](../../../class/Gem=3a=3aVersion.md) を参照してください。
...
- **param** `gem` -- Gem の名前の文字列か、Gem の依存関係を [Gem::Dependency](../../../class/Gem=3a=3aDependency.md) のインスタンスで指定します。
...
- **SEE** [Gem::Version](../../../class/Gem=3a=3aVersion.md)
