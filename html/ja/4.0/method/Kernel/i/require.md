...
RubyGems を require すると、[Kernel#require](../../../method/Kernel/i/require.md) が Gem を要求されたときにロードするように置き換えます。

再定義された [Kernel#require](../../../method/Kernel/i/require.md) を呼び出すと以下の事を行います。
