...
`console_mode` は現在のモードを表す [IO::ConsoleMode](../../../class/IO=3a=3aConsoleMode.md) のインスタンスを返します。
`console_mode=` は mode に指定したモードを端末に設定します。[IO#raw](../../../method/IO/i/raw.md) などでモードを
...
- **SEE** [IO::ConsoleMode](../../../class/IO=3a=3aConsoleMode.md)
