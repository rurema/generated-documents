...
### def readline(rs = $/, chomp: false)   -> String
### def readline(limit, chomp: false)     -> String
### def readline(rs, limit, chomp: false) -> String
...
読み込んだ文字列を変数 [m:$_] にセットします。[IO#gets](../../../method/IO/i/gets.md) との違いは EOF での振る舞いのみです。
