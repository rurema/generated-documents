...
[Enumerable#sort](../../../method/Enumerable/i/sort.md) と比較して sort_by が優れている点として、比較条件が複雑な場合の速度が挙げられます。
...
- **SEE** [Enumerable#sort](../../../method/Enumerable/i/sort.md)
