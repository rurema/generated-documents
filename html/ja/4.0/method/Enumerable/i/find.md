...
### def find(ifnone = nil)   -> Enumerator
### def detect(ifnone = nil) -> Enumerator
### def find(ifnone = nil) {|item| ... }   -> object
### def detect(ifnone = nil) {|item| ... } -> object
...
- **param** `ifnone` --  call メソッドを持つオブジェクト (例えば [Proc](../../../class/Proc.md)) を指定します。
