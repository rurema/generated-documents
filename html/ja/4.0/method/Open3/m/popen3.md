...
引数 cmd はそのまま [Kernel?.spawn](../../../method/Kernel/m/spawn.md) に渡されます。
[Kernel?.spawn](../../../method/Kernel/m/spawn.md)と同様に、引数リストの最初に環境変数をハッシュ形式で指定する事ができます。
...
[Kernel?.spawn](../../../method/Kernel/m/spawn.md)と同様に、引数リストの最後にオプションをハッシュ形式で指定する事ができます。
...
- **SEE** [Kernel?.spawn](../../../method/Kernel/m/spawn.md)
