...
source には [String](../../../class/String.md)、[IO](../../../class/IO.md)、[REXML::Document](../../../class/REXML=3a=3aDocument.md) のいずかが指定できます。 REXML::Document を指定するとコンテキストと要素、属性が複製されます。
文字列の場合はそれを XML と見なしてパースします。
IOの場合は、XML文書を読み出してパースします。

context で「コンテキスト」を指定します。テキストノードの空白や特殊文字の取り扱いを [Hash](../../../class/Hash.md) で指定します。
