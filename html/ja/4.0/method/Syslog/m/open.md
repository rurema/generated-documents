...
ブロック付きで呼ばれた場合は、self を引数としてブロックを実行し、最後に [Syslog?.close](../../../method/Syslog/m/close.md) を行います。
...
- **raise** `RuntimeError` -- syslogを既に開いていた場合は[RuntimeError](../../../class/RuntimeError.md)が発生します。

- **return** -- self を返します。

syslogを既に開いていた場合は[RuntimeError](../../../class/RuntimeError.md)が発生します。
