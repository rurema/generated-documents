...
文字列から16進数に変換したハッシュ値を直接得たい場合は、[Digest::Base.hexdigest](../../../method/Digest=3a=3aBase/s/hexdigest.md) を使うこともできます。

- **SEE** [Digest::Base.hexdigest](../../../method/Digest=3a=3aBase/s/hexdigest.md), [Digest::Base#hexdigest](../../../method/Digest=3a=3aBase/i/hexdigest.md)
