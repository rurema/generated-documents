...
- **param** `collection` -- クラス、モジュールを追加する先を [Hash](../../../class/Hash.md) オブジェクトで指定します。
...
- **param** `superclass` -- 追加するクラスの親クラスを [RDoc::NormalClass](../../../class/RDoc=3a=3aNormalClass.md) オブジェクトで指定します。
