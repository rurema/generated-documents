...
### def Ripper.lex(src, filename = '-', lineno = 1, raise_errors: false) -> [[Integer, Integer], Symbol, String, Ripper::Lexer::State]

Ruby プログラム str をトークンに分割し、そのリストを返します。
ただし [Ripper.tokenize](../../../method/Ripper/s/tokenize.md) と違い、トークンの種類と位置情報も付属します。
