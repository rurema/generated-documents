...
- **param** `n` -- 取得する要素数を整数で指定します。整数以外のオブジェクトを指定した場合は to_int メソッドによる暗黙の型変換を試みます。
...
([Range#exclude_end?](../../../method/Range/i/exclude_end=3f.md) の戻り値)に関わらず終端の要素を返す事に注意してください。
...
- **SEE** [Range#first](../../../method/Range/i/first.md)
