...
[Benchmark?.benchmark](../../../method/Benchmark/m/benchmark.md) メソッドの引数を簡略化したものです。

[Benchmark?.benchmark](../../../method/Benchmark/m/benchmark.md) メソッドと同様に働きます。
...
- **SEE** [Benchmark?.benchmark](../../../method/Benchmark/m/benchmark.md)
