...
'SSLv23' を指定し、[OpenSSL::SSL::SSLContext#options=](../../../method/OpenSSL=3a=3aSSL=3a=3aSSLContext/i/options=3d.md) で
[OpenSSL::SSL::OP_NO_SSLv2](../../../method/OpenSSL=3a=3aSSL/c/OP_NO_SSLv2.md) を指定します。

- **param** `ssl_method` -- プロトコルを表す文字列もしくはシンボル
- **SEE** [OpenSSL::SSL::SSLContext#ssl_version=](../../../method/OpenSSL=3a=3aSSL=3a=3aSSLContext/i/ssl_version=3d.md)
