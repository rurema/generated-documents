...
- **param** `name` -- 名前文字列
- **param** `pkey` -- 秘密鍵([OpenSSL::PKey::PKey](../../../class/OpenSSL=3a=3aPKey=3a=3aPKey.md) のサブクラスのオブジェクト)
- **param** `cert` -- 証明書([OpenSSL::X509::Certificate](../../../class/OpenSSL=3a=3aX509=3a=3aCertificate.md) のオブジェクト)
- **param** `ca` -- CA証明書群([OpenSSL::X509::Certificate](../../../class/OpenSSL=3a=3aX509=3a=3aCertificate.md) の配列)
