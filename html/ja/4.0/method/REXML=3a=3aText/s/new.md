...
[REXML::Text](../../../class/REXML=3a=3aText.md) オブジェクトの場合はその内容が複製されます。
...
entity_filter が nil の場合(デフォルトの場合)、テキストがどのようにエスケープされるかは、そのノードが属する文書([REXML::Document](../../../class/REXML=3a=3aDocument.md))の
DTD([REXML::DocType](../../../class/REXML=3a=3aDocType.md), [REXML::Document#doctype](../../../method/REXML=3a=3aDocument/i/doctype.md))
...
- **param** `arg` -- テキストデータ(文字列)もしくは元データの [REXML::Text](../../../class/REXML=3a=3aText.md) オブジェクト
...
```ruby title="doctype があり、実体が宣言されている場合"
