...
引数が1つの場合は [Socket::Option](../../../class/Socket=3a=3aOption.md) で設定値を表現します。
...
- **param** `optval` --   設定値
- **param** `socketoption` -- 設定値を表す [Socket::Option](../../../class/Socket=3a=3aOption.md) オブジェクト

- **raise** `Errno::EXXX` --  オプションの設定に失敗した場合発生します。
- **SEE** [BasicSocket#getsockopt](../../../method/BasicSocket/i/getsockopt.md)
