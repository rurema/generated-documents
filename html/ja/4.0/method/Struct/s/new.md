...
[Struct](../../../class/Struct.md) クラスに新しいサブクラスを作って、それを返します。
...
メンバ名に [String](../../../class/String.md) を指定できるのは後方互換性のためだと考えた方が良いでしょう。
したがって、メンバ名は [Symbol](../../../class/Symbol.md) で指定するのが無難です。

- **param** `args` -- 構造体を定義するための可変長引数。[String](../../../class/String.md) または [Symbol](../../../class/Symbol.md) を指定します。
...
args[0] が [String](../../../class/String.md) の場合、クラス名になるので、大文字で始まる必要があります。つまり、以下のような指定はエラーになります。
...
また args[1..-1] は、[Symbol](../../../class/Symbol.md) か [String](../../../class/String.md) で指定します。
...
args[0] が [Symbol](../../../class/Symbol.md) の場合、生成した構造体クラスは名前の無いクラスになります。名前の無いクラスは最初に名前を求める際に代入されている定数名を検索し、見つかった定数名をクラス名とします。
...
- **SEE** [Class.new](../../../method/Class/s/new.md)
