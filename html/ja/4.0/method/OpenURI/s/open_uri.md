...
URI である文字列 name のリソースを取得して [StringIO](../../../class/StringIO.md) オブジェクトとして返します。
...
options には [Hash](../../../class/Hash.md) を与えます。理解するハッシュのキーは以下のシンボル、
- :proxy
- :progress_proc
- :content_length_proc
...
- **`:ssl_ca_cert`**:
  ...
  詳しくは
  [OpenSSL::X509::Store#add_file](../../../method/OpenSSL=3a=3aX509=3a=3aStore/i/add_file.md)、
...
- **`:ssl_verify_mode`**:
  ...
  詳しくは [OpenSSL::SSL::SSLContext#verify_mode=](../../../method/OpenSSL=3a=3aSSL=3a=3aSSLContext/i/verify_mode=3d.md) を参照してください。
