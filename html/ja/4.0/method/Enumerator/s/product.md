...
与えた [Enumerable](../../../class/Enumerable.md) なオブジェクトの直積(デカルト積)を列挙する Enumerator を作って返します。

[Enumerator::Product.new](../../../method/Enumerator=3a=3aProduct/s/new.md) と同じです。
...
- **SEE** [Enumerator::Product](../../../class/Enumerator=3a=3aProduct.md)
