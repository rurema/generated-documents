requires=rdoc.parser,rdoc,rdoc.code_objects,rdoc.code_object,rdoc.context,rdoc.top_level,rdoc.class_module,rdoc.normal_class,rdoc.normal_module,rdoc.anon_class,rdoc.single_class,rdoc.any_method,rdoc.alias,rdoc.ghost_method,rdoc.meta_method,rdoc.attr,rdoc.constant,rdoc.require,rdoc.include,rdoc.stats,rdoc.parser.simple,rdoc.parser.c,rdoc.parser.ruby,e2mmap,irb.slex,irb.notifier,irb.output=2dmethod,rdoc.token_stream,rdoc.known_classes,rdoc.parser.changelog,time,rdoc.parser.markdown,rdoc.parser.rd
classes=RDoc=Parser=C
methods=
sublibraries=
is_sublibrary=true
category=
source_location=/tmp/claude-1000/-home-debian-rurema/3717a77b-67d6-4a40-b15e-a41ca141ab34/scratchpad/frozen.xqkPhh/src/refm/api/src/rdoc/parser/c.rd
